...
function validateForm() {
    ...
    document.getElementById("emailError").innerText = /\S+@\S+\.\S+/.test(email) ? "" : "Invalid";
    document.getElementById("phoneError").innerText = /^\d{10}$/.test(phone) ? "" : "Must be 10 digits";
    document.getElementById("dateTimeError").innerText = new Date(dateTime) > new Date() ? "" : "Select future date";
    document.getElementById("termsError").innerText = terms ? "" : "Agreeing to terms is compulsory.";
